...
<?php $sum = 0 ?>
    <div class="container">
        ...
        <div class="row d-flex justify-content-between align-items-center table">
            ...
            <div class="col-lg-1"><a href="/cart/minus/{{$c->id}}" class="minus">-</a></div>
            <div class="col-lg-3"><p class="m-0">{{$c->count}}</p></div>
            <div class="col-lg-1"><a href="/cart/plus/{{$c->id}}" class="plus">+</a></div>
        ...
        <form action="/cart/pay/{{$carts[0]->id_basket}}" class="mt-4">
